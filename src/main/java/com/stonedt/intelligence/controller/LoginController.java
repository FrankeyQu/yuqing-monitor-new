            ...
            if (user.getStatus() == 0) {
                ...
                if (MD5Util.getMD5(password).equals(user.getPassword())) {
                    ...
                    if (status == 2) {
                        ...
                        Integer loginCount = user.getLogin_count() == null ? 0 : user.getLogin_count();
                        Integer login_count = loginCount + 1;
                        ...
                        try {
                            ...
                            log.warn("更新登录次数失败: {}", e.getMessage());
                        }
                        try {

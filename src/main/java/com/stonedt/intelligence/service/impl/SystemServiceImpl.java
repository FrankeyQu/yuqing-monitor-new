...
public class SystemServiceImpl implements SystemService {
    ...
    public ResponseEntity<InputStreamResource> uploadProductManual() {
        return buildProductManualResponse("attachment");
    }

    @Override
    public ResponseEntity<InputStreamResource> viewProductManual() {
        return buildProductManualResponse("inline");
    }

    private ResponseEntity<InputStreamResource> buildProductManualResponse(String dispositionType) {
        try {
            ...
            headers.add("Content-Disposition", dispositionType + "; filename=" + URLEncoder.encode(fileName, "UTF-8"));

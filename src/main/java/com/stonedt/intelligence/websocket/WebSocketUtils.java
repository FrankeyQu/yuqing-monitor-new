...
//	System.out.println(data);
    ...
    public static String data(String keyword, String xml, String pageNoData) {
        return data(keyword, xml, pageNoData, "");
    }
	
    public static String data(String keyword,String xml,String pageNoData,String websocketUrl){
        if (websocketUrl == null || websocketUrl.trim().length() == 0) {
            throw new IllegalArgumentException("legacy websocket url is not configured");
        }
